...
copy boost\lib\boost_process-%VC_VERSION%-mt-%BOOST_NELSON%.dll %NELSON_DIR%\bin\%PLATFORM_NELSON%\boost_process-%VC_VERSION%-mt-%BOOST_NELSON%.dll
...
copy .\vc14.5-runtime\*.exe  %NELSON_DIR%\bin\%PLATFORM_NELSON%\*.exe

rem intel runtime
rem copy .\intel-runtime\*.dll %NELSON_DIR%\bin\%PLATFORM_NELSON%\*.dll
...
copy .\openblas\lib\*.lib %NELSON_DIR%\bin\%PLATFORM_NELSON%\*.lib
copy .\openblas\bin\*.dll %NELSON_DIR%\bin\%PLATFORM_NELSON%\*.dll

rem mpi library
rem copy .\mpi\License\license_sdk.rtf %NELSON_DIR%\bin\%PLATFORM_NELSON%\license_sdk.rtf
rem copy .\mpi\MSMpiSetup.exe %NELSON_DIR%\bin\%PLATFORM_NELSON%\MSMpiSetup.exe
...
rem fftw3
copy .\fftw\bin\*.dll %NELSON_DIR%\bin\%PLATFORM_NELSON%\*.dll
